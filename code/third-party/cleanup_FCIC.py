...
<html><head><title>K:\DOCS\\52400.TXT</title>
...
print broken
#print len(broken)/len(paths)

	#print "Document Header"
	#print repr(content[:len(HTML_HEADER)])
	#print "Script Header"
	#print repr(HTML_HEADER)
	#broke1 = ''
	#broke2 = ''
	#for char1, char2 in zip(content[:len(HTML_HEADER)], HTML_HEADER):
	#	if char1!=char2:
	#		broke1 += char1
	#		broke2 += char2
	#print "Document Header"
